...
client.login("ODQ2MzU4NzA0NTg3NjY5NTE1.YKuW9w.3bq1emTCRgSF-kHxUSpHUycmkjM");
const prefix = "VM!";
//Düzenlenecek tek kısım diğer kodlara ellemeyiniz.\\

client.on("ready", () => console.log("Youtube Adlı Kulanıcı Başarıyla Aktif Oldu!!"));//Bot aktif olunca, konsola yazılcak mesaj. Tırnak içindeki yazıyı değiştirebilirsiniz.
